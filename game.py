...
class App:
    ...
    def update_start_scene(self):
        if pyxel.btnp(pyxel.GAMEPAD1_BUTTON_B) or pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT):
    ...
    def update_play_scene(self):
        ...
        # 自分の移動
        if pyxel.btn(pyxel.GAMEPAD1_BUTTON_DPAD_LEFT) or pyxel.btn(pyxel.KEY_LEFT) and self.player_x > -4:
            self.player_x -= 1
        elif pyxel.btn(pyxel.GAMEPAD1_BUTTON_DPAD_RIGHT) or pyxel.btn(pyxel.KEY_RIGHT) and self.player_x < SCREEN_WIDTH - 13:
            self.player_x += 1
    ...
    def update(self):
        if pyxel.btnp(pyxel.GAMEPAD1_BUTTON_Y) or pyxel.btnp(pyxel.KEY_ESCAPE):
            pyxel.quit()
    ...
    def draw_start_scene(self):
        ...
        pyxel.text(SCREEN_WIDTH//2-8, SCREEN_HEIGHT//2, "Tap A Button!!",
                   pyxel.COLOR_PINK)
